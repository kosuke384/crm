                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                                    <Link as="buttom" :href="route('items.create')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">商品登録</Link>
                                </div>
                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tr v-for="item in items" :key="item.id">
                                        <td class="border-t-2 border-gray-200 px-4 py-3">
                                            <Link class="text-red" :href="route('items.show',{item: item.id })">{{ item.id }}</Link>
                                        </td>
